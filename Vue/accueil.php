...
<body>
    <nav>
        ...
        <ul id="navbarLinks">
            ...
            <li><a href="#">Planning et réservation</a>
                <ul class="submenu">
                    <li><a href="#">Emploi du temps</a></li>
                    <li><a href="#">Réservation salles et matériels</a></li>
                </ul>
            </li>
            <li><a href="#">Vie étudiante</a>
                <ul class="submenu">
    ...
    <div class="schedule-container">
        ...
        <div class="navigation">
            <a href="?action=accueil&week=<?= $currentWeek - 1 ?>">Semaine Précédente</a>
            <a href="?action=accueil&week=<?= $currentWeek + 1 ?>">Semaine Suivante</a>
        </div>
